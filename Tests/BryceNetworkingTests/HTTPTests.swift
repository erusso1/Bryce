...
//
//        Bryce.request(.posts, as: [Post].self) { result in
//                        
//            XCTAssertNotNil(try? result.get())
//            expectation0.fulfill()
//        }
//        
//        Bryce.request(on: Endpoint(components: "posts")) { result in
//            
//            switch result {
...
//        }
//        
//        Bryce.request(on: Endpoint(components: .posts), as: Post.self) { result in
//        
...
//        }
//        
//        Bryce.request(.comments, parameters: Parameters(postId: 1), as: [Comment].self) { result in
//            
...
//        
//        Bryce.request(on: endpoint) { (post: Post?, error: Error?) in
//            
...
//        )
//        
//        Bryce.request(.posts, .id("1"), as: Post.self) { result in
//            
//            XCTAssertNil(result.error)
//            XCTAssertNotNil(result.value)
//            
...
////        let endpoint = Endpoint(components: "posts", "1")
////
////        Bryce.request(on: endpoint, etagEnabled: true, as: Post.self) { result in
////
////            XCTAssertNil(result.error)
////            XCTAssertNotNil(result.value)
////
...
////                XCTAssertNotNil(result.value)
////
////                Bryce.request(on: endpoint, as: Post.self) { result in
////
////                    XCTAssertNil(result.error)
////                    XCTAssertNotNil(result.value)
////
...
//        )
//        
//        Bryce.request(.posts, .id("1"), as: Comment.self) { result in
//            
...
////                Bryce.authorization = newAuth
////
////                XCTAssertEqual(newAuth, Bryce.authorization)
////
////                expectation0.fulfill()
////
////                callback()
...
////        ))
////
////        Bryce.authorization = .bearer(token: UUID().uuidString, refreshToken: UUID().uuidString, expiration: Date(timeIntervalSinceNow: 3600))
////
////        print("Sending original request")
////
////        Bryce.request(on: baseURL) { result in
////
////            XCTAssertNotNil(result.error)
////
